    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MercadoLibreAuths", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryColor = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "#000000"),
                    SecondaryColor = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "#FFFFFF"),
                    GoogleAnalytics = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    GoogleTagManager = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhatsAppMessage = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Banners_Active_DisplayOrder",
                table: "Banners",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MercadoLibreAuths_UserId",
                table: "MercadoLibreAuths",
                column: "UserId",
                unique: true);
